...
import {TransportObject} from '../../models/transport-object.interface';
...
export class RestClient {
   ...
   * @constructor type of response T
   */
  public POST<T>(url: string, payload: TransportObject): Promise<T> {
   ...
   * @constructor type of response T
   */
  public PUT<T>(url: string, payload: TransportObject): Promise<T> {
